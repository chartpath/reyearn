...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("accuracy", sa.DECIMAL(precision=6), nullable=True),
        sa.Column("precision", sa.DECIMAL(precision=6), nullable=True),
        sa.Column("recall", sa.DECIMAL(precision=6), nullable=True),
        sa.Column("f1", sa.DECIMAL(precision=6), nullable=True),
        sa.PrimaryKeyConstraint("id"),
